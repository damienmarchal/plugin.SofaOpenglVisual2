...
#include <SofaOpenglVisual2/PointSplatRenderer.h>

namespace sofaopenglvisual2
{
...
static int PointSplatRendererClass = RegisterObject("Render a set of points using point splatting technique.")
...
void PointSplatRenderer::drawTransparent(const VisualParams* vparams)
{
